...
# Read in the data
dat = fread("C:\\Users\\HL522\\Mass General Brigham/Data Repository - Documents\\Dataset Files\\Mass Vital Statistics- Death Data\\Analysis\\Mortality Cluster Analysis\\MA_OD_rx.csv")
dat <- dat %>%
  dplyr::select(-V1)
```
...
```{r}
models <- readRDS("C:\\Users\\HL522\\Mass General Brigham/Data Repository - Documents\\Dataset Files\\Mass Vital Statistics- Death Data\\Analysis\\Mortality Cluster Analysis\\LCA_models.rds")
```
